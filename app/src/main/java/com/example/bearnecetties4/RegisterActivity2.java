        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(RegisterActivity2.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(RegisterActivity2.this, "Registering user successful", Toast.LENGTH_SHORT).show();//////This code displays messages to the user // when the user successfully
                    startActivity(new Intent(RegisterActivity2.this,MainActivity.class));
                    finish();
                } else {                                                                                                                   /////////////or fails to register correctly
